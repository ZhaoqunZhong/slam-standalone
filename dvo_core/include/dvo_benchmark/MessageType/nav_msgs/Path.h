...
#ifndef OB_VISLAM_NAV_MSGS_MESSAGE_PATH_H
#define OB_VISLAM_NAV_MSGS_MESSAGE_PATH_H

#include "MessageType/geometry_msgs/PoseStamped.h"
...
namespace nav_msgs {
    ...
    {
        ob_slam::message_operations::Printer<nav_msgs::Path_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
