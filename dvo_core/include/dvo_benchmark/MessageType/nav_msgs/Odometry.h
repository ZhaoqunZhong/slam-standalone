...
#ifndef OB_VISLAM_NAV_MSGS_MESSAGE_ODOMETRY_H
#define OB_VISLAM_NAV_MSGS_MESSAGE_ODOMETRY_H

#include "MessageType/geometry_msgs/PoseWithCovariance.h"
#include "MessageType/geometry_msgs/TwistWithCovariance.h"
...
namespace nav_msgs {
    ...
    {
        ob_slam::message_operations::Printer<nav_msgs::Odometry_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
