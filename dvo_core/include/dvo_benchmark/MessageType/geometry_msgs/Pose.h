...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSE_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSE_H

#include "MessageType/geometry_msgs/Point.h"
#include "MessageType/geometry_msgs/Quaternion.h"
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::Pose_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
