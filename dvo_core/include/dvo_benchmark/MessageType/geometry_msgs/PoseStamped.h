...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSESTAMPED_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSESTAMPED_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::PoseStamped_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
