...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POINT32_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POINT32_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::Point32_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
