...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POINTSTAMPED_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POINTSTAMPED_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::PointStamped_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
