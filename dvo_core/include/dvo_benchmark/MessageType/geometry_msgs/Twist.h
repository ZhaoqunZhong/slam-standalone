...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_TWIST_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_TWIST_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::Twist_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace geometry_msgs
}
...
namespace message_operations {
    ...
    struct Printer<geometry_msgs::Twist_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const geometry_msgs::Twist_<ContainerAllocator>& v)
        {
            s << indent << "linear: ";
            s << std::endl;
