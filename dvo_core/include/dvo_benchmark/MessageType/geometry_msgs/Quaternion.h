...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_QUATERNION_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_QUATERNION_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::Quaternion_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace geometry_msgs
}
