...
#ifndef OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSEWITHCOVARIANCE_H
#define OB_VISLAM_GEOMETRY_MSGS_MESSAGE_POSEWITHCOVARIANCE_H
...
namespace geometry_msgs {
    ...
    {
        ob_slam::message_operations::Printer<geometry_msgs::PoseWithCovariance_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace geometry_msgs
}
