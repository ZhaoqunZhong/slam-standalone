...
#ifndef OB_VISLAM_VISUALIZATION_MSGS_MESSAGE_MARKERARRAY_H
#define OB_VISLAM_VISUALIZATION_MSGS_MESSAGE_MARKERARRAY_H
...
#include "MessageType/visualization_msgs/Marker.h"
...
namespace visualization_msgs {
    ...
    {
        ob_slam::message_operations::Printer<visualization_msgs::MarkerArray_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
    ...
    struct Definition<visualization_msgs::MarkerArray_<ContainerAllocator>> {
        static const char* value()
        {
            return "Marker[] markers\n"
                   ...
                   "# See http://www.ob_slam.org/wiki/rviz/DisplayTypes/Marker and http://www.ob_slam.org/wiki/rviz/Tutorials/Markers%3A%20Basic%20Shapes for more information on using this message with rviz\n"
                   "\n"
                   "uint8 ARROW=0\n"
                   "uint8 CUBE=1\n"
                   "uint8 SPHERE=2\n"
