...
#ifndef OB_VISLAM_VISUALIZATION_MSGS_MESSAGE_MARKER_H
#define OB_VISLAM_VISUALIZATION_MSGS_MESSAGE_MARKER_H
...
#include "MessageType/geometry_msgs/Point.h"
#include "MessageType/geometry_msgs/Pose.h"
#include "MessageType/geometry_msgs/Vector3.h"
#include "MessageType/std_msgs/ColorRGBA.h"
...
namespace visualization_msgs {
    ...
    struct Marker_ {
        ...
        typedef ob_slam::Duration _lifetime_type;
...
#undef DELETEALL
    ...
    {
        ob_slam::message_operations::Printer<visualization_msgs::Marker_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
...
namespace message_traits {
    ...
    struct Definition<visualization_msgs::Marker_<ContainerAllocator>> {
        static const char* value()
        {
            return "# See http://www.ob_slam.org/wiki/rviz/DisplayTypes/Marker and http://www.ob_slam.org/wiki/rviz/Tutorials/Markers%3A%20Basic%20Shapes for more information on using this message with rviz\n"
                   "\n"
                   "uint8 ARROW=0\n"
                   "uint8 CUBE=1\n"
                   "uint8 SPHERE=2\n"
...
namespace message_operations {
    ...
    struct Printer<visualization_msgs::Marker_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const visualization_msgs::Marker_<ContainerAllocator>& v)
        {
            ...
            s << indent << "lifetime: ";
            Printer<ob_slam::Duration>::stream(s, indent + "  ", v.lifetime);
