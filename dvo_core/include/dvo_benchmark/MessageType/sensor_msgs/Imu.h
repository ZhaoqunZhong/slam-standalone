...
#ifndef OB_VISLAM_SENSOR_MSGS_MESSAGE_IMU_H
#define OB_VISLAM_SENSOR_MSGS_MESSAGE_IMU_H
...
namespace sensor_msgs {
    ...
    {
        ob_slam::message_operations::Printer<sensor_msgs::Imu_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace sensor_msgs
}
