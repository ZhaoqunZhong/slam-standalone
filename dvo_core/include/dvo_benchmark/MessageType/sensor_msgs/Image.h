...
#ifndef OB_VISLAM_SENSOR_MSGS_MESSAGE_IMAGE_H
#define OB_VISLAM_SENSOR_MSGS_MESSAGE_IMAGE_H
...
namespace sensor_msgs {
    ...
    {
        ob_slam::message_operations::Printer<sensor_msgs::Image_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
