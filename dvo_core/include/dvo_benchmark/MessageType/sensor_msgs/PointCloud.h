...
#ifndef OB_VISLAM_SENSOR_MSGS_MESSAGE_POINTCLOUD_H
#define OB_VISLAM_SENSOR_MSGS_MESSAGE_POINTCLOUD_H
...
namespace sensor_msgs {
    ...
    {
        ob_slam::message_operations::Printer<sensor_msgs::PointCloud_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
