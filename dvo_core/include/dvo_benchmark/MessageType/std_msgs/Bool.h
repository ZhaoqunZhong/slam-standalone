...
#ifndef OB_VISLAM_STD_MSGS_MESSAGE_BOOL_H
#define OB_VISLAM_STD_MSGS_MESSAGE_BOOL_H
...
namespace std_msgs {
    ...
    {
        ob_slam::message_operations::Printer<std_msgs::Bool_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
