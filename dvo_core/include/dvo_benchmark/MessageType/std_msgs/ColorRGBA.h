...
#ifndef OB_VISLAM_STD_MSGS_MESSAGE_COLORRGBA_H
#define OB_VISLAM_STD_MSGS_MESSAGE_COLORRGBA_H
...
namespace std_msgs {
    ...
    {
        ob_slam::message_operations::Printer<std_msgs::ColorRGBA_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
