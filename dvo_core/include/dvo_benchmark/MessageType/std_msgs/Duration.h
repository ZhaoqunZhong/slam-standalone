...
#ifndef OB_VISLAM_STD_MSGS_MESSAGE_DURATION_H
#define OB_VISLAM_STD_MSGS_MESSAGE_DURATION_H
...
namespace std_msgs {
    ...
    struct Duration_ {
        ...
        typedef ob_slam::Duration _data_type;
        _data_type data;
    ...
    {
        ob_slam::message_operations::Printer<std_msgs::Duration_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace std_msgs
}
...
namespace message_operations {
    ...
    struct Printer<std_msgs::Duration_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const std_msgs::Duration_<ContainerAllocator>& v)
        {
            s << indent << "data: ";
            Printer<ob_slam::Duration>::stream(s, indent + "  ", v.data);
        }
    };
