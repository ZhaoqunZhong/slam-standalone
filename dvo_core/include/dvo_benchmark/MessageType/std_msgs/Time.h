...
#ifndef OB_VISLAM_STD_MSGS_MESSAGE_TIME_H
#define OB_VISLAM_STD_MSGS_MESSAGE_TIME_H
...
namespace std_msgs {
    ...
    struct Time_ {
        ...
        typedef ob_slam::Time _data_type;
        _data_type data;
    ...
    {
        ob_slam::message_operations::Printer<std_msgs::Time_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace std_msgs
}
...
namespace message_operations {
    ...
    struct Printer<std_msgs::Time_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const std_msgs::Time_<ContainerAllocator>& v)
        {
            s << indent << "data: ";
            Printer<ob_slam::Time>::stream(s, indent + "  ", v.data);
        }
    };
