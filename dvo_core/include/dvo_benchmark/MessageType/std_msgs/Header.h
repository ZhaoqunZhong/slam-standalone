...
#ifndef OB_VISLAM_STD_MSGS_MESSAGE_HEADER_H
#define OB_VISLAM_STD_MSGS_MESSAGE_HEADER_H
...
namespace std_msgs {
    ...
    struct Header_ {
        ...
        typedef ob_slam::Time _stamp_type;
        _stamp_type stamp;
    ...
    {
        ob_slam::message_operations::Printer<std_msgs::Header_<ContainerAllocator>>::stream(s, "", v);
        return s;
    }
} // namespace std_msgs
}
...
namespace message_operations {
    ...
    struct Printer<std_msgs::Header_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const std_msgs::Header_<ContainerAllocator>& v)
        {
            ...
            s << indent << "stamp: ";
            Printer<ob_slam::Time>::stream(s, indent + "  ", v.stamp);
            s << indent << "frame_id: ";
