...
static bool findClosestEntry(FileReader<EntryT>& reader, const ob_slam::Time& reference)
{
...
template<class EntryT>
static bool findClosestEntries(FileReader<EntryT>& reader, const ob_slam::Time& reference, EntryT& before, EntryT& after)
{
